 ...
 */
!function(a){"use strict";function b(a,b){return a+".touchspin_"+b}function c(c,d){return a.map(c,function(a){return b(a,d)})}var d=0;a.fn.TouchSpin=function(b){if("destroy"===b)return void this.each(function(){var b=a(this),d=b.data();a(document).off(c(["mouseup","touchend","touchcancel","mousemove","touchmove","scroll","scrollstart"],d.spinnerid).join(" "))});var e={min:0,max:100,initval:"",replacementval:"",step:1,decimals:0,stepinterval:100,forcestepdivisibility:"round",stepintervaldelay:500,verticalbuttons:!1,verticalupclass:"glyphicon glyphicon-chevron-up",verticaldownclass:"glyphicon glyphicon-chevron-down",prefix:"",postfix:"",prefix_extraclass:"",postfix_extraclass:"",booster:!0,boostat:10,maxboostedstep:!1,mousewheel:!0,buttondown_class:"btn btn-primary btn-sm",buttonup_class:"btn btn-primary btn-sm",buttondown_txt:'<span class="glyphicon glyphicon-minus"></span>',buttonup_txt:'<span class="glyphicon glyphicon-plus"></span>'},f={min:"min",max:"max",initval:"init-val",replacementval:"replacement-val",step:"step",decimals:"decimals",stepinterval:"step-interval",verticalbuttons:"vertical-buttons",verticalupclass:"vertical-up-class",verticaldownclass:"vertical-down-class",forcestepdivisibility:"force-step-divisibility",stepintervaldelay:"step-interval-delay",prefix:"prefix",postfix:"postfix",prefix_extraclass:"prefix-extra-class",postfix_extraclass:"postfix-extra-class",booster:"booster",boostat:"boostat",maxboostedstep:"max-boosted-step",mousewheel:"mouse-wheel",buttondown_class:"button-down-class",buttonup_class:"button-up-class",buttondown_txt:"button-down-txt",buttonup_txt:"button-up-txt"};return this.each(function(){function g(){if(!J.data("alreadyinitialized")){if(J.data("alreadyinitialized",!0),d+=1,J.data("spinnerid",d),!J.is("input"))return void console.log("Must be an input.");j(),h(),u(),m(),p(),q(),r(),s(),D.input.css("display","block")}}function h(){""!==B.initval&&""===J.val()&&J.val(B.initval)}function i(a){l(a),u();var b=D.input.val();""!==b&&(b=Number(D.input.val()),D.input.val(b.toFixed(B.decimals)))}function j(){B=a.extend({},e,K,k(),b)}function k(){var b={};return a.each(f,function(a,c){var d="bts-"+c;J.is("[data-"+d+"]")&&(b[a]=J.data(d))}),b}function l(b){B=a.extend({},B,b)}function m(){var a=J.val(),b=J.parent();""!==a&&(a=Number(a).toFixed(B.decimals)),J.data("initvalue",a).val(a),J.addClass("form-control input-sm text-center"),b.hasClass("input-group")?n(b):o()}function n(b){b.addClass("bootstrap-touchspin");var c,d,e=J.prev(),f=J.next(),g='<span class="input-group-addon bootstrap-touchspin-prefix">'+B.prefix+"</span>",h='<span class="input-group-addon bootstrap-touchspin-postfix">'+B.postfix+"</span>";e.hasClass("input-group-btn")?(c='<button class="'+B.buttondown_class+' bootstrap-touchspin-down" type="button">'+B.buttondown_txt+"</button>",e.append(c)):(c='<span class="input-group-btn"><button class="'+B.buttondown_class+' bootstrap-touchspin-down" type="button">'+B.buttondown_txt+"</button></span>",a(c).insertBefore(J)),f.hasClass("input-group-btn")?(d='<button class="'+B.buttonup_class+' bootstrap-touchspin-up" type="button">'+B.buttonup_txt+"</button>",f.prepend(d)):(d='<span class="input-group-btn"><button class="'+B.buttonup_class+' bootstrap-touchspin-up" type="button">'+B.buttonup_txt+"</button></span>",a(d).insertAfter(J)),a(g).insertBefore(J),a(h).insertAfter(J),C=b}function o(){var b;b=B.verticalbuttons?'<div class="input-group bootstrap-touchspin"><span class="input-group-addon bootstrap-touchspin-prefix">'+B.prefix+'</span><span class="input-group-addon bootstrap-touchspin-postfix">'+B.postfix+'</span><span class="input-group-btn-vertical"><button class="'+B.buttondown_class+' bootstrap-touchspin-up" type="button"><i class="'+B.verticalupclass+'"></i></button><button class="'+B.buttonup_class+' bootstrap-touchspin-down" type="button"><i class="'+B.verticaldownclass+'"></i></button></span></div>':'<div class="input-group bootstrap-touchspin"><span class="input-group-btn"><button class="'+B.buttondown_class+' bootstrap-touchspin-down" type="button">'+B.buttondown_txt+'</button></span><span class="input-group-addon bootstrap-touchspin-prefix">'+B.prefix+'</span><span class="input-group-addon bootstrap-touchspin-postfix">'+B.postfix+'</span><span class="input-group-btn"><button class="'+B.buttonup_class+' bootstrap-touchspin-up" type="button">'+B.buttonup_txt+"</button></span></div>",C=a(b).insertBefore(J),a(".bootstrap-touchspin-prefix",C).after(J),J.hasClass("input-sm")?C.addClass("input-group-sm"):J.hasClass("input-lg")&&C.addClass("input-group-lg")}function p(){D={down:a(".bootstrap-touchspin-down",C),up:a(".bootstrap-touchspin-up",C),input:a("input",C),prefix:a(".bootstrap-touchspin-prefix",C).addClass(B.prefix_extraclass),postfix:a(".bootstrap-touchspin-postfix",C).addClass(B.postfix_extraclass)}}function q(){""===B.prefix&&D.prefix.hide(),""===B.postfix&&D.postfix.hide()}function r(){J.on("keydown",function(a){var b=a.keyCode||a.which;38===b?("up"!==M&&(w(),z()),a.preventDefault()):40===b&&("down"!==M&&(x(),y()),a.preventDefault())}),J.on("keyup",function(a){var b=a.keyCode||a.which;38===b?A():40===b&&A()}),J.on("blur",function(){u()}),D.down.on("keydown",function(a){var b=a.keyCode||a.which;(32===b||13===b)&&("down"!==M&&(x(),y()),a.preventDefault())}),D.down.on("keyup",function(a){var b=a.keyCode||a.which;(32===b||13===b)&&A()}),D.up.on("keydown",function(a){var b=a.keyCode||a.which;(32===b||13===b)&&("up"!==M&&(w(),z()),a.preventDefault())}),D.up.on("keyup",function(a){var b=a.keyCode||a.which;(32===b||13===b)&&A()}),D.down.on("mousedown.touchspin",function(a){D.down.off("touchstart.touchspin"),J.is(":disabled")||(x(),y(),a.preventDefault(),a.stopPropagation())}),D.down.on("touchstart.touchspin",function(a){D.down.off("mousedown.touchspin"),J.is(":disabled")||(x(),y(),a.preventDefault(),a.stopPropagation())}),D.up.on("mousedown.touchspin",function(a){D.up.off("touchstart.touchspin"),J.is(":disabled")||(w(),z(),a.preventDefault(),a.stopPropagation())}),D.up.on("touchstart.touchspin",function(a){D.up.off("mousedown.touchspin"),J.is(":disabled")||(w(),z(),a.preventDefault(),a.stopPropagation())}),D.up.on("mouseout touchleave touchend touchcancel",function(a){M&&(a.stopPropagation(),A())}),D.down.on("mouseout touchleave touchend touchcancel",function(a){M&&(a.stopPropagation(),A())}),D.down.on("mousemove touchmove",function(a){M&&(a.stopPropagation(),a.preventDefault())}),D.up.on("mousemove touchmove",function(a){M&&(a.stopPropagation(),a.preventDefault())}),a(document).on(c(["mouseup","touchend","touchcancel"],d).join(" "),function(a){M&&(a.preventDefault(),A())}),a(document).on(c(["mousemove","touchmove","scroll","scrollstart"],d).join(" "),function(a){M&&(a.preventDefault(),A())}),J.on("mousewheel DOMMouseScroll",function(a){if(B.mousewheel&&J.is(":focus")){var b=a.originalEvent.wheelDelta||-a.originalEvent.deltaY||-a.originalEvent.detail;a.stopPropagation(),a.preventDefault(),0>b?x():w()}})}function s(){J.on("touchspin.uponce",function(){A(),w()}),J.on("touchspin.downonce",function(){A(),x()}),J.on("touchspin.startupspin",function(){z()}),J.on("touchspin.startdownspin",function(){y()}),J.on("touchspin.stopspin",function(){A()}),J.on("touchspin.updatesettings",function(a,b){i(b)})}function t(a){switch(B.forcestepdivisibility){case"round":return(Math.round(a/B.step)*B.step).toFixed(B.decimals);case"floor":return(Math.floor(a/B.step)*B.step).toFixed(B.decimals);case"ceil":return(Math.ceil(a/B.step)*B.step).toFixed(B.decimals);default:return a}}function u(){var a,b,c;return a=J.val(),""===a?void(""!==B.replacementval&&(J.val(B.replacementval),J.trigger("change"))):void(B.decimals>0&&"."===a||(b=parseFloat(a),isNaN(b)&&(b=""!==B.replacementval?B.replacementval:0),c=b,b.toString()!==a&&(c=b),b<B.min&&(c=B.min),b>B.max&&(c=B.max),c=t(c),Number(a).toString()!==c.toString()&&(J.val(c),J.trigger("change"))))}function v(){if(B.booster){var a=Math.pow(2,Math.floor(L/B.boostat))*B.step;return B.maxboostedstep&&a>B.maxboostedstep&&(a=B.maxboostedstep,E=Math.round(E/a)*a),Math.max(B.step,a)}return B.step}function w(){u(),E=parseFloat(D.input.val()),isNaN(E)&&(E=0);var a=E,b=v();E+=b,E>B.max&&(E=B.max,J.trigger("touchspin.on.max"),A()),D.input.val(Number(E).toFixed(B.decimals)),a!==E&&J.trigger("change")}function x(){u(),E=parseFloat(D.input.val()),isNaN(E)&&(E=0);var a=E,b=v();E-=b,E<B.min&&(E=B.min,J.trigger("touchspin.on.min"),A()),D.input.val(E.toFixed(B.decimals)),a!==E&&J.trigger("change")}function y(){A(),L=0,M="down",J.trigger("touchspin.on.startspin"),J.trigger("touchspin.on.startdownspin"),H=setTimeout(function(){F=setInterval(function(){L++,x()},B.stepinterval)},B.stepintervaldelay)}function z(){A(),L=0,M="up",J.trigger("touchspin.on.startspin"),J.trigger("touchspin.on.startupspin"),I=setTimeout(function(){G=setInterval(function(){L++,w()},B.stepinterval)},B.stepintervaldelay)}function A(){switch(clearTimeout(H),clearTimeout(I),clearInterval(F),clearInterval(G),M){case"up":J.trigger("touchspin.on.stopupspin"),J.trigger("touchspin.on.stopspin");break;case"down":J.trigger("touchspin.on.stopdownspin"),J.trigger("touchspin.on.stopspin")}L=0,M=!1}var B,C,D,E,F,G,H,I,J=a(this),K=J.data(),L=0,M=!1;g()})}}(jQuery);/*!Copyright (C) 2002-2017 Framtidsforum I&M AB | SpreadsheetConverter.com*/
var ssc=ssc||{};ssc.maxFileSize=4194304,ssc.maxFileCount=10,function(e,i,t,n){e(function(){e("input[type=file]").change(function(){i(e(this).parents("td"),e(this)[0].files)}),e("input[type=file]").parents("td").click(function(){e(this).find("input[type=file]").click()}),e("input[type=file]").click(function(e){e.stopPropagation()}),e("input[type=file]").parents("td").on("drag dragstart dragend dragover dragenter dragleave drop",function(e){e.preventDefault(),e.stopPropagation()}).on("dragover dragenter",function(){e(this).addClass("is-dragover")}).on("dragleave dragend drop",function(){e(this).removeClass("is-dragover")}).on("drop",function(t){var n=t.originalEvent.dataTransfer.files;i(e(this),n)});var i=function(i,t){var n=t.length,s=[];e("input:file").each(function(i,t){var n=e(this).data("files");Array.isArray(n)||(n=JSON.parse(n)),s=s.concat(n)});for(var a=0;a<n;a++)if(s.length+ssc.pendingUploads<ssc.maxFileCount)if(ssc.maxFileSize>=t[a].size){i.find(".uploading").show(),i.find(".browse").hide();var o=e("<li></li>");i.find(".uploading").find("ul").append(o),o.fileUploader({file:t[a],tobeupload:!0})}else alert('The file "'+t[a].name+'" is not attached. Reason: the file is larger than the maximum file size for this service ('+parseInt(ssc.maxFileSize/1024/1024)+" MB)");else alert('The file "'+t[a].name+'" is not attached. Reason: Only '+ssc.maxFileCount+" files can be attached to this form.")}});var s=s||{};s.Widget="<span class='glyphicon glyphicon-file'></span><span class='glyphicon glyphicon-remove pull-right ui-btn ui-icon-delete ui-btn-inline ui-btn-icon-notext ui-corner-all' title='Remove'></span><span class='filename'></span><div class='progress progress-file-upload'><div class='progress-bar progress-bar-success' role='progressbar' style='width:0%;'></div></div>";var a=function(i,t){this.element=e(i),this.options=e.extend({},t),this.element.append(s.Widget),this.element.on("click",".glyphicon-remove,.ui-icon-delete",e.proxy(this.abort,this)),this.element.find(".filename").html(t.file.name),void 0!=t.tobeupload&&t.tobeupload&&this.upload()};a.prototype={constructor:a,upload:function(){var i=new FormData;i.append("file",this.options.file);var t=this,n=0;this.ajax=e.ajax({cache:!1,crossDomain:!0,url:"https://share.spreadsheetconverter.com/attach",type:"POST",data:i,enctype:"multipart/form-data",processData:!1,contentType:!1,xhr:function(){var i=e.ajaxSettings.xhr();return i.upload.onprogress=function(e){n=e.loaded,e.loaded/e.total<=.95&&t.element.find(".progress-bar").width(e.loaded/e.total*100+"%")},i.upload.onload=function(){},i},beforeSend:function(){ssc.pendingUploads++,t.element.find(".glyphicon-file").css("opacity","0.6"),t.element.find(".filename").css("opacity","0.6")},complete:function(){ssc.pendingUploads>0&&ssc.pendingUploads--,t.element.find(".glyphicon-file").css("opacity","1"),t.element.find(".filename").css("opacity","1")},success:function(i){t.element.find(".progress").hide(),t.element.find(".progress-bar").width("0%"),t.fileid=i.fileid;var n=t.element.parents("td").find("input[type=file]"),s=n.data("files");s.push({id:i.fileid,file:t.options.file.name}),n.data("files",s);var a=n.attr("id");e("#cx_"+a+"_files").val(e.map(s,function(e){return"<li>"+e.file+"</li>"}).join("")),ssc.realtimesync&&ssc.realtimesync.connection&&1==ssc.realtimesync.connection.readyState&&ssc.realtimesync.messageSend_setvalues(n[0].id,JSON.stringify(s))},error:function(e){t.element.find(".progress-bar").width("0%"),"abort"!=e.statusText&&(alert('The server did not accept the file "'+t.options.file.name+'". Reason: '+("Request Entity Too Large"==e.statusText?"the file is larger than the maximum file size for this service ("+parseInt(n/1024/1024)+" MB)":e.statusText)),t.destroy())}})},abort:function(e){null!=this.ajax&&(this.ajax.abort(),this.ajax=null),this.destroy(),e.stopPropagation()},destroy:function(){var i=this,t=i.element.parents("td").find("input[type=file]"),n=t.data("files"),s=e.map(n,function(e,t){if(e.file==i.options.file.name)return t});if(s.length>0){n.splice(s[0],1),t.data("files",n);var a=t.attr("id");e("#cx_"+a+"_files").val(e.map(n,function(e){return"<li>"+e.file+"</li>"}).join("")),ssc.realtimesync&&ssc.realtimesync.connection&&1==ssc.realtimesync.connection.readyState&&ssc.realtimesync.messageSend_setvalues(t[0].id,JSON.stringify(n))}this.element.fadeOut("slow").promise().done(function(){0==e(this).siblings("li").length&&(e(this).parents("td").find(".uploading").hide(),e(this).parents("td").find(".browse").show()),e(this).remove()})}},e.fn.fileUploader=function(i){return this.each(function(){e.data(this,"ssc_fileuploader")||e.data(this,"ssc_fileuploader",new a(this,i))}),this}}(jQuery,window,document);/*! ========================================================================
...
this.activeTarget=b,this.clear();var c=this.selector+'[data-target="'+b+'"],'+this.selector+'[href="'+b+'"]',d=a(c).parents("li").addClass("active");d.parent(".dropdown-menu").length&&(d=d.closest("li.dropdown").addClass("active")),d.trigger("activate.bs.scrollspy")},b.prototype.clear=function(){a(this.selector).parentsUntil(this.options.target,".active").removeClass("active")};var d=a.fn.scrollspy;a.fn.scrollspy=c,a.fn.scrollspy.Constructor=b,a.fn.scrollspy.noConflict=function(){return a.fn.scrollspy=d,this},a(window).on("load.bs.scrollspy.data-api",function(){a('[data-spy="scroll"]').each(function(){var b=a(this);c.call(b,b.data())})})}(jQuery),+function(a){"use strict";function b(b){return this.each(function(){var d=a(this),e=d.data("bs.tab");e||d.data("bs.tab",e=new c(this)),"string"==typeof b&&e[b]()})}var c=function(b){this.element=a(b)};c.VERSION="3.3.7",c.TRANSITION_DURATION=150,c.prototype.show=function(){var b=this.element,c=b.closest("ul:not(.dropdown-menu)"),d=b.data("target");if(d||(d=b.attr("href"),d=d&&d.replace(/.*(?=#[^\s]*$)/,"")),!b.parent("li").hasClass("active")){var e=c.find(".active:last a"),f=a.Event("hide.bs.tab",{relatedTarget:b[0]}),g=a.Event("show.bs.tab",{relatedTarget:e[0]});if(e.trigger(f),b.trigger(g),!g.isDefaultPrevented()&&!f.isDefaultPrevented()){var h=a(d);this.activate(b.closest("li"),c),this.activate(h,h.parent(),function(){e.trigger({type:"hidden.bs.tab",relatedTarget:b[0]}),b.trigger({type:"shown.bs.tab",relatedTarget:e[0]})})}}},c.prototype.activate=function(b,d,e){function f(){g.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!1),b.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",!0),h?(b[0].offsetWidth,b.addClass("in")):b.removeClass("fade"),b.parent(".dropdown-menu").length&&b.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!0),e&&e()}var g=d.find("> .active"),h=e&&a.support.transition&&(g.length&&g.hasClass("fade")||!!d.find("> .fade").length);g.length&&h?g.one("bsTransitionEnd",f).emulateTransitionEnd(c.TRANSITION_DURATION):f(),g.removeClass("in")};var d=a.fn.tab;a.fn.tab=b,a.fn.tab.Constructor=c,a.fn.tab.noConflict=function(){return a.fn.tab=d,this};var e=function(c){c.preventDefault(),b.call(a(this),"show")};a(document).on("click.bs.tab.data-api",'[data-toggle="tab"]',e).on("click.bs.tab.data-api",'[data-toggle="pill"]',e)}(jQuery),+function(a){"use strict";function b(b){return this.each(function(){var d=a(this),e=d.data("bs.affix"),f="object"==typeof b&&b;e||d.data("bs.affix",e=new c(this,f)),"string"==typeof b&&e[b]()})}var c=function(b,d){this.options=a.extend({},c.DEFAULTS,d),this.$target=a(this.options.target).on("scroll.bs.affix.data-api",a.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",a.proxy(this.checkPositionWithEventLoop,this)),this.$element=a(b),this.affixed=null,this.unpin=null,this.pinnedOffset=null,this.checkPosition()};c.VERSION="3.3.7",c.RESET="affix affix-top affix-bottom",c.DEFAULTS={offset:0,target:window},c.prototype.getState=function(a,b,c,d){var e=this.$target.scrollTop(),f=this.$element.offset(),g=this.$target.height();if(null!=c&&"top"==this.affixed)return e<c&&"top";if("bottom"==this.affixed)return null!=c?!(e+this.unpin<=f.top)&&"bottom":!(e+g<=a-d)&&"bottom";var h=null==this.affixed,i=h?e:f.top,j=h?g:b;return null!=c&&e<=c?"top":null!=d&&i+j>=a-d&&"bottom"},c.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(c.RESET).addClass("affix");var a=this.$target.scrollTop(),b=this.$element.offset();return this.pinnedOffset=b.top-a},c.prototype.checkPositionWithEventLoop=function(){setTimeout(a.proxy(this.checkPosition,this),1)},c.prototype.checkPosition=function(){if(this.$element.is(":visible")){var b=this.$element.height(),d=this.options.offset,e=d.top,f=d.bottom,g=Math.max(a(document).height(),a(document.body).height());"object"!=typeof d&&(f=e=d),"function"==typeof e&&(e=d.top(this.$element)),"function"==typeof f&&(f=d.bottom(this.$element));var h=this.getState(g,b,e,f);if(this.affixed!=h){null!=this.unpin&&this.$element.css("top","");var i="affix"+(h?"-"+h:""),j=a.Event(i+".bs.affix");if(this.$element.trigger(j),j.isDefaultPrevented())return;this.affixed=h,this.unpin="bottom"==h?this.getPinnedOffset():null,this.$element.removeClass(c.RESET).addClass(i).trigger(i.replace("affix","affixed")+".bs.affix")}"bottom"==h&&this.$element.offset({top:g-b-f})}};var d=a.fn.affix;a.fn.affix=b,a.fn.affix.Constructor=c,a.fn.affix.noConflict=function(){return a.fn.affix=d,this},a(window).on("load",function(){a('[data-spy="affix"]').each(function(){var c=a(this),d=c.data();d.offset=d.offset||{},null!=d.offsetBottom&&(d.offset.bottom=d.offsetBottom),null!=d.offsetTop&&(d.offset.top=d.offsetTop),b.call(c,d)})})}(jQuery);function recalc_onclick(e){ssc.recalcSource=e,co.XLEW_1_1_1=document.getElementById("XLEW_1_1_1").value,co.subject=document.getElementById("subject").value,co.XLEW_1_5_2=eegetdropdownvalue(document.getElementsByName("XLEW_1_5_2")),co.XLEW_1_6_2=eegetdropdownvalue(document.getElementsByName("XLEW_1_6_2")),co.XLEW_1_10_2=document.getElementById("XLEW_1_10_2").checked,co.XLEW_1_10_3=document.getElementById("XLEW_1_10_3").checked,co.XLEW_1_11_2=document.getElementById("XLEW_1_11_2").checked,co.XLEW_1_11_3=document.getElementById("XLEW_1_11_3").checked,co.XLEW_1_12_2=document.getElementById("XLEW_1_12_2").checked,co.XLEW_1_12_3=document.getElementById("XLEW_1_12_3").checked,co.XLEW_1_13_2=document.getElementById("XLEW_1_13_2").checked,co.XLEW_1_13_3=document.getElementById("XLEW_1_13_3").checked,co.XLEW_1_14_2=document.getElementById("XLEW_1_14_2").checked,co.XLEW_1_14_3=document.getElementById("XLEW_1_14_3").checked,co.XLEW_1_15_2=document.getElementById("XLEW_1_15_2").checked,co.XLEW_1_15_3=document.getElementById("XLEW_1_15_3").checked,co.XLEW_1_16_2=document.getElementById("XLEW_1_16_2").checked,co.XLEW_1_16_3=document.getElementById("XLEW_1_16_3").checked,co.XLEW_1_17_2=document.getElementById("XLEW_1_17_2").checked,co.XLEW_1_17_3=document.getElementById("XLEW_1_17_3").checked,co.XLEW_1_18_2=document.getElementById("XLEW_1_18_2").checked,co.XLEW_1_18_3=document.getElementById("XLEW_1_18_3").checked,co.XLEW_1_19_2=document.getElementById("XLEW_1_19_2").checked,co.XLEW_1_19_3=document.getElementById("XLEW_1_19_3").checked,co.XLEW_1_23_2=document.getElementById("XLEW_1_23_2").checked,co.XLEW_1_23_3=document.getElementById("XLEW_1_23_3").checked,co.XLEW_1_24_2=document.getElementById("XLEW_1_24_2").checked,co.XLEW_1_24_3=document.getElementById("XLEW_1_24_3").checked,co.XLEW_1_25_2=document.getElementById("XLEW_1_25_2").checked,co.XLEW_1_25_3=document.getElementById("XLEW_1_25_3").checked,co.XLEW_1_26_2=document.getElementById("XLEW_1_26_2").checked,co.XLEW_1_26_3=document.getElementById("XLEW_1_26_3").checked,co.XLEW_1_27_2=document.getElementById("XLEW_1_27_2").checked,co.XLEW_1_27_3=document.getElementById("XLEW_1_27_3").checked,co.xlew_1_31_1=eeparseFloatV(document.getElementById("xlew_1_31_1").value),co.xlew_1_35_2=eeparseFloatV(document.getElementById("xlew_1_35_2").value),co.xlew_1_37_2=eeparseFloatV(document.getElementById("xlew_1_37_2").value),co.xlew_1_38_2=eeparseFloatV(document.getElementById("xlew_1_38_2").value),co.xlew_1_41_2=eeparseFloatV(document.getElementById("xlew_1_41_2").value),co.xlew_1_42_2=eeparseFloatV(document.getElementById("xlew_1_42_2").value),co.xlew_1_43_2=eeparseFloatV(document.getElementById("xlew_1_43_2").value),co.xlew_1_46_1=eeparseFloatV(document.getElementById("xlew_1_46_1").value),co.xlew_1_49_2=eeparseFloatV(document.getElementById("xlew_1_49_2").value),co.xlew_1_50_2=eeparseFloatV(document.getElementById("xlew_1_50_2").value),co.xlew_1_51_2=eeparseFloatV(document.getElementById("xlew_1_51_2").value),co.xlew_1_54_1=eeparseFloatV(document.getElementById("xlew_1_54_1").value),co.xlew_1_57_2=eeparseFloatV(document.getElementById("xlew_1_57_2").value),co.xlew_1_58_2=eeparseFloatV(document.getElementById("xlew_1_58_2").value),co.xlew_1_59_2=eeparseFloatV(document.getElementById("xlew_1_59_2").value),co.XLEW_1_62_3=document.getElementById("XLEW_1_62_3").checked,co.XLEW_1_63_3=document.getElementById("XLEW_1_63_3").checked,co.XLEW_1_64_3=document.getElementById("XLEW_1_64_3").checked,co.XLEW_1_65_3=document.getElementById("XLEW_1_65_3").checked,co.XLEW_1_68_1=document.getElementById("XLEW_1_68_1").checked,co.XLEW_1_71_1=document.getElementById("XLEW_1_71_1").checked,co.XLEW_1_74_1=document.getElementById("XLEW_1_74_1").checked,co.XLEW_1_77_1=document.getElementById("XLEW_1_77_1").checked,co.XLEW_1_80_1=document.getElementById("XLEW_1_80_1").checked,co.XLEW_1_83_1=document.getElementById("XLEW_1_83_1").checked,co.XLEW_1_86_1=document.getElementById("XLEW_1_86_1").checked,co.XLEW_1_89_2=document.getElementById("XLEW_1_89_2").checked,co.XLEW_1_90_2=document.getElementById("XLEW_1_90_2").checked,co.XLEW_1_93_1=document.getElementById("XLEW_1_93_1").checked,co.XLEW_1_96_1=document.getElementById("XLEW_1_96_1").checked,co.XLEW_1_99_1=document.getElementById("XLEW_1_99_1").checked,co.XLEW_1_102_1=document.getElementById("XLEW_1_102_1").checked,co.XLEW_1_105_1=document.getElementById("XLEW_1_105_1").checked,co.XLEW_1_108_1=document.getElementById("XLEW_1_108_1").checked,co.xlew_1_111_1=eeparseFloatV(document.getElementById("xlew_1_111_1").value),co.XLEW_1_114_1=document.getElementById("XLEW_1_114_1").checked,co.xlew_1_117_1=document.getElementById("xlew_1_117_1").value,co.email=document.getElementById("email").value,calc(co),void 0!==ssc&&void 0!==ssc.realtimesync&&void 0!==ssc.realtimesync.connection&&1==ssc.realtimesync.connection.readyState?ssc.realtimesync.coUpdate(co,e):void 0!==ssc&&void 0!==ssc.realtimesync&&ssc.realtimesync.wsUrl&&ssc.realtimesync.IsCloseByError&&!ssc.realtimesync.IsErrorMsgDialogShown&&(alert("Realtime-Sync is Disconnected, This Form will not save in server and will not collaborate with your partner.")||(ssc.realtimesync.IsErrorMsgDialogShown=!0)),document.getElementById("XLEW_1_3_2").value=eedatefmt(fmtdate1,co.XLEW_1_3_2),document.getElementById("XLEW_1_37_1").value=co.XLEW_1_37_1,document.getElementById("XLEW_1_38_1").value=co.XLEW_1_38_1}function eegetdropdownvalue(e){var t,n=$(e),o=n.get(0).tagName;return t="INPUT"==o?$("input[name="+n.attr("name")+"]:checked").attr("data-value"):"SELECT"==o?n.find(":selected").attr("data-value"):n.val(),void 0==t?0:eeunpackdropdownvalue(t)}function myIsNaN(e){return isNaN(e)||"number"==typeof e&&!isFinite(e)}function mod(e,t){return e-t*Math.floor(e/t)}function round(e,t){if(isFinite(e)&&isFinite(t)){var n=0>e?-1:1,o=Math.abs(e),r=Math.pow(10,t);return n*Math.round(o*r)/r}return NaN}function b2s(e){return e?eetrue:eefalse}function eedisplayFloat(e){if(myIsNaN(e))return Number.NaN;var t=String(e);return near0RegExp.test(t)&&(e=round(e,8),t=String(e)),t.replace(/\./g,eedec)}function eedisplayScientific(e,t){if(myIsNaN(e))return Number.NaN;var n=String(e.toExponential(t));return n.replace(/\./g,eedec)}function eedisplayFloatND(e,t){if(myIsNaN(e))return Number.NaN;var n=round(e,t);if(t>0){var o=String(n);if(-1!=o.indexOf("e"))return o;if(-1!=o.indexOf("E"))return o;var r=o.split(".");if(r.length<2){var a="00000000000000".substring(0,t);return r[0].toString()+eedec+a}var a=(r[1].toString()+"00000000000000").substring(0,t);return r[0].toString()+eedec+a}return n}function eedisplayPercent(e){return myIsNaN(e)?Number.NaN:eedisplayFloat(100*e)+"%"}function eedisplayPercentND(e,t){return myIsNaN(e)?Number.NaN:eedisplayFloatND(100*e,t)+"%"}function eedisplayFloatNDTh(e,t){if(myIsNaN(e))return Number.NaN;var n=round(e,t);if(t>0){var o=String(n);if(-1!=o.indexOf("e"))return o;if(-1!=o.indexOf("E"))return o;var r=o.split("."),a=eeinsertThousand(r[0].toString());if(r.length<2){var i="00000000000000".substring(0,t);return a+eedec+i}var i=(r[1].toString()+"00000000000000").substring(0,t);return a+eedec+i}return eeinsertThousand(n.toString())}function eedisplayPercentNDTh(e,t){return myIsNaN(e)?Number.NaN:eedisplayFloatNDTh(100*e,t)+"%"}function eeparseFloatV(e){if(""==e)return e;if(e=String(e).replace(eedecreg,"."),!eeparseFloatVreg.test(e))return e;var t=parseFloat(e);return isNaN(t)?e:t}function eedisplayFloatNDV(e,t){return""==e?e:isFinite(e)?eedisplayFloatND(e,t):e}function eeinsertThousand(e){if(""==e||e.indexOf("e")>=0)return e;var t="";"-"==e.charAt(0)&&(t="-",e=e.substring(1));for(var n="",o=e.length-1,r=0;o>=r;r++)r>0&&r%3==0&&(n=eeth+n),n=e.charAt(o-r)+n;return t+n}function eedatefmt(e,t){if(!isFinite(t))return Number.NaN;for(var n=0,o=0,r="",a=e.length,i=0;a>i;i++)if(e[i]>31)r+=fmtstrings[e[i]-32];else switch(e[i]){case 2:r+=eemonth(t);break;case 3:o=eemonth(t),10>o&&(r+="0"),r+=o;break;case 4:r+=fmtmonthnamesshort[eemonth(t)-1];break;case 5:r+=fmtmonthnameslong[eemonth(t)-1];break;case 6:r+=eeday(t);break;case 7:o=eeday(t),10>o&&(r+="0"),r+=o;break;case 8:r+=fmtdaynamesshort[weekday(t,1)-1];break;case 9:r+=fmtdaynameslong[weekday(t,1)-1];break;case 10:o=year(t)%100,10>o&&(r+="0"),r+=o;break;case 11:r+=year(t);break;case 12:r+=hour(t);break;case 13:o=hour(t),10>o&&(r+="0"),r+=o;break;case 14:o=hour(t)%12,r+=0==o?"12":o%12;break;case 15:o=hour(t)%12,0==o?r+="12":(10>o&&(r+="0"),r+=o);break;case 16:r+=minute(t);break;case 17:o=minute(t),10>o&&(r+="0"),r+=o;break;case 18:r+=second(t);break;case 19:o=second(t),10>o&&(r+="0"),r+=o;break;case 21:case 22:r+=hour(t)<12?"AM":"PM";break;case 23:r+=eedisplayFloat(t);break;case 24:o=e[++i],r+=eedisplayFloatND(t,o);break;case 25:o=e[++i],r+=eedisplayFloatNDTh(t,o);break;case 26:r+=eedisplayPercent(t);break;case 27:o=e[++i],r+=eedisplayPercentND(t,o);break;case 28:o=e[++i],r+=eedisplayPercentNDTh(t,o);break;case 29:o=e[++i],r+=eedisplayScientific(t,o);break;case 30:n=e[++i],o=hour(t)+24*Math.floor(t),o=o.toString(),o.length<n&&(r+="00000000000000".substring(0,n-o.length)),r+=o}return r}function eeunpackdropdownvalue(e){if(e.length<2)return e;var t=e.substring(0,2),n=e.substring(2);return"b:"==t?"true"==n.toLowerCase():"n:"==t?parseFloat(n):"s:"==t?n:e}function leap_gregorian(e){return e%4==0&&!(e%100==0&&e%400!=0)}function gregorian_to_jd(e,t,n){return GREGORIAN_EPOCH-0+365*(e-1)+Math.floor((e-1)/4)+-Math.floor((e-1)/100)+Math.floor((e-1)/400)+Math.floor((367*t-362)/12+(2>=t?0:leap_gregorian(e)?-1:-2)+n)}function jd_to_gregorian(e){var t,n,o,r,a,i,c,s,l,d,_,u;t=Math.floor(e),n=t-GREGORIAN_EPOCH-1,o=Math.floor(n/146097),r=mod(n,146097),a=Math.floor(r/36524),i=mod(r,36524),c=Math.floor(i/1461),s=mod(i,1461),l=Math.floor(s/365),d=400*o+100*a+4*c+l,4!=a&&4!=l&&d++,_=t-gregorian_to_jd(d,1,1),u=t<gregorian_to_jd(d,3,1)?0:leap_gregorian(d)?1:2;var m=Math.floor((12*(_+u)+373)/367),f=t-gregorian_to_jd(d,m,1)+1;return new Array(d,m,f)}function date(e,t,n){if(!isFinite(n)||!isFinite(t)||!isFinite(e))return Number.NaN;if(1900>e&&(e+=1900),e>9999)return Number.NaN;var o=e,r=t;if(t>0)o=e+Math.floor((t-1)/12),r=(t-1)%12+1;else if(0>t){var a=Math.ceil(-t/12);o=e-a,r+=12*a}var i=Math.floor(gregorian_to_jd(o,r,n)-2415020);return i>59?i+1:i}function eeday(e){if(!isFinite(e))return Number.NaN;if(1>e)return 0;e>60&&e--;var t=jd_to_gregorian(e+2415020);return t[2]}function hour(e){if(!isFinite(e))return Number.NaN;var t=Math.floor(86400*(e-Math.floor(e))+.5);return Math.floor(t/3600)}function minute(e){if(!isFinite(e))return Number.NaN;var t=Math.floor(86400*(e-Math.floor(e))+.5);return Math.floor(t/60)%60}function eemonth(e){if(!isFinite(e))return Number.NaN;if(1>e)return 1;e>60&&e--;var t=jd_to_gregorian(e+2415020);return t[1]}function second(e){if(!isFinite(e))return Number.NaN;var t=Math.floor(86400*(e-Math.floor(e))+.5);return t%60}function today(){var e=new Date;return date(e.getFullYear(),e.getMonth()+1,e.getDate())}function weekday(e,t){if(!isFinite(t)||!isFinite(e))return Number.NaN;if(1>t||t>3)return Number.NaN;var n=Math.floor(e+6)%7;switch(Math.floor(t)){case 1:return n+1;case 2:return(n+6)%7+1;case 3:return(n+6)%7}return"hej"}function year(e){if(!isFinite(e))return Number.NaN;if(1>e)return 1900;e>60&&e--;var t=jd_to_gregorian(e+2415020);return t[0]}function postcode(){document.getElementById("XLEW_1_1_1").value="Remote site inventory"}function TriggerOnchange(e){var t=jQuery.Event("change");$("#"+e).trigger(t)}function submitClick(e){if(focused=!1,ssc.asyncRecalc=!1,recalc_onclick("submit"),ssc.asyncRecalc=!0,ssc.pendingUploads>0)return alert("Please wait until all attachments have finished uploading."),!1;$("#formc").valid();var t=$(".error").filter(":hiddenByParent").length;if(t>0)return showValidateMessage(ssc.exMsg+" : "+t+(t>1?" errors":" error"),"Form validation"),"function"==typeof ssc.focusOnElement&&ssc.focusOnElement($(".error").first()),!1;if(ssc.Global.formStorage)if(window.indexedDB=window.indexedDB||window.mozIndexedDB||window.webkitIndexedDB||window.msIndexedDB,ssc.utils.checkIfBrowserSupportStorageSystem()&&window.indexedDB){var n=ssc.Spinner.create($(e));n.start(),ssc.formSubmitModule.callIfOnlineElse(function(){n.stop(),ssc.formSubmitModule.options.before_onlineformsubmit_callback()},function(){n.stop(),ssc.formSubmitModule.showOfflineConformationDialog()})}else $("#formc").submit();else $("#formc").submit()}function LoadFromQueryString(){var e=decodeURI(document.location.search),t=!1;e.indexOf("_readonly")>-1&&(t=!0),e.length>0&&$.each(e.substr(1).split("&"),function(e,t){var n=t.split("=");if(2==n.length){var o=n[0].toString(),r=n[1].toString();ssc.formBinder.bind(o,r)}})}function navigate(e){var t=e.keyCode|e.which;if(13==t||40==t||38==t){var n=$(e.target||e.srcElement);if(!n.is("textarea")&&(!n.is("select")||38!=t&&40!=t)){for(var o=parseInt(n.attr("data-sheet"),10),r=parseInt(n.attr("data-row"),10),a=parseInt(n.attr("data-col"),10),i=!1,c=$("#sheet-"+o),s='input:not(":hidden,:button,[readonly=readonly],:disabled"),select,a.ui-slider-handle,textarea',l=r+1,d=r-1,_=l,u=d;40==t&&_>=l||38==t&&d>=u;){var m=c.find(s).filter("[data-sheet="+o+"][data-row="+(38==t?d:l)+"][data-col="+a+"]");if(m.length>0){m.focus(),m.is("input:text, textarea")&&m.select(),i=!0;break}var f;void 0==c.data("col"+a)?(f=c.find(s).filter("[data-sheet="+o+"][data-col="+a+"]").map(function(){return parseInt($(this).attr("data-row"),10)}).toArray(),c.data("col"+a,f)):f=c.data("col"+a),_=f[f.length-1],u=f[0];var h="indexOf"in Array.prototype?f.indexOf(r):$.inArray(r,f);if(40==t&&_>r)l=f[h+1];else{if(!(38==t&&r>u))break;d=f[h-1]}}if(!i){var g;g=38==t?parseInt(n.attr("tabindex"),10)-1:parseInt(n.attr("tabindex"),10)+1;var p=c.find(s).filter("[data-sheet][data-row][data-col][tabindex="+g+"]");if(p.length>0)p.is(":radio")&&(p=p.filter(":checked")),p.length>0&&(p.focus(),p.is("input:text, textarea")&&p.select());else{var E=c.find(s).filter("[data-sheet][data-row][data-col][tabindex]:first");E.focus(),E.is("input:text, textarea")&&E.select()}}e.preventDefault?e.preventDefault():e.returnValue=!1}}}function calendarCallback(e){var t=$("#"+e.id).data("caltype"),n="popup"==t?e.id:"cal_"+e.id,o=$("#"+n),r=e.s1;void 0===o.data("is-dirty")&&(""==r||isNaN(r)||(o.datepicker("update",new Date(year(r),eemonth(r)-1,eeday(r))),EE.eeRecalcNeeded=!0))}function showValidateMessage(e,t){toastr?t&&t.length>0?toastr.error(e,t):toastr.error(e):alert(e)}function dv(e,t){var n="#"+e.id,o=$(n);if(0!=o.length){var r=ssc.validator.element(n);0==r&&void 0!==o?o.tooltip({tigger:"hover",placement:"auto right",delay:{show:100,hide:0}}).data("bs.tooltip").tip().addClass("stop"):(o.removeClass("error"),o.tooltip("destroy"))}}function resetClick(){void 0!==ssc&&void 0!==ssc.realtimesync&&void 0!==ssc.realtimesync.connection&&(ssc.realtimesync.connection.close(),ssc.realtimesync.connected=!1,ssc.realtimesync.ShowDisconnectAlert($(".toolbar-panel-right"))),document.formc.reset(),postcode(),resetSlider("xlew_1_31_1",0),resetSlider("xlew_1_35_2",0),resetSlider("xlew_1_37_2",0),resetSlider("xlew_1_38_2",0),resetSlider("xlew_1_41_2",0),resetSlider("xlew_1_42_2",0),resetSlider("xlew_1_43_2",0),resetSlider("xlew_1_46_1",0),resetSlider("xlew_1_49_2",0),resetSlider("xlew_1_50_2",0),resetSlider("xlew_1_51_2",0),resetSlider("xlew_1_54_1",0),resetSlider("xlew_1_57_2",0),resetSlider("xlew_1_58_2",0),resetSlider("xlew_1_59_2",0),resetSlider("xlew_1_111_1",0),ssc.isAttachmentExist()&&$("input[type=file]").parents("td").find(".uploading").find("ul").find("li").each(function(){$(this).data("ssc_fileuploader").destroy()}),LoadFromQueryString(),recalc_onclick("reset")}function resetSlider(e,t){$("#"+e).TouchSpin("setValue",t)}var eeisus=0,eetrue="TRUE",eefalse="FALSE",eedec=".",eeth=" ",eedecreg=new RegExp("\\.","g"),eethreg=new RegExp(" ","g"),eecurrencyreg=new RegExp("[$]","g"),eepercentreg=new RegExp("%","g"),fmtdaynamesshort=new Array("dim.","lun.","mar.","mer.","jeu.","ven.","sam."),fmtdaynameslong=new Array("dimanche","lundi","mardi","mercredi","jeudi","vendredi","samedi"),fmtmonthnamesshort=new Array("janv.","févr.","mars","avr.","mai","juin","juil.","août","sept.","oct.","nov.","déc."),fmtmonthnameslong=new Array("janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"),fmtstrings=new Array(","," "),fmtdate1=[9,32,33,5,33,7,32,33,11],co=new Object,near0RegExp=new RegExp("[.](.*0000000|.*9999999)"),eeparseFloatVreg=new RegExp("^ *-?[0-9.]+ *$"),GREGORIAN_EPOCH=1721425;jQuery.expr[":"].hiddenByParent=function(e){if(e.id.startsWith("xl_"))return!0;var t=!1,n=$(e);return void 0!=n&&(t="none"!=n.closest("tr[class^='_css']").css("display")),1==t&&(t="none"!=n.closest(".tab-pane>div").css("display")),t};var ssccf1n=function(e,t,n,o){switch(e){case"image":$("#"+t).attr("src",$("#"+o).attr("src"))}},ssccf4n=function(e,t,n,o,r,a,i){},ssc=ssc||{};ssc.pendingUploads=0,ssc.recalcSource="",ssc.APPNAME="App Gestion stock operationnel",ssc.exMsg="The fields with the red border are required or invalid.",$(window).on("scroll",function(){var e=$(window);$(".position-fixed-x").css("left",e.scrollLeft()),$(".position-fixed-y").css("top",e.scrollTop())}),ssc.Dialog={},ssc.Dialog.BeforeSubmitDesc="The form is being submitted.",ssc.Dialog.OfflineHeading="Save until online",ssc.Dialog.OfflineDesc="You are currently offline and the submit failed. Do you want to save the submit and send it later when you are online.",ssc.Dialog.OfflineConfirm="Do you want to save?",ssc.Dialog.OfflineSubmitHeading="Offline forms submit confirmation",ssc.Dialog.OfflineSubmitDesc="There are Offline form(s), which are now ready to submit in server.",ssc.Dialog.OfflineSubmitConfirm="Do you want to submit?",ssc.Dialog.FailOfflineHeading="Offline Form submit failed",ssc.Dialog.FailOfflineDesc="Unable to connect to the Internet. Please try submitting the offline forms later in internet connection.",ssc.Dialog.OfflineSubmitWait="It may take sometime to finish all submits depending on the size of offline forms and internet connection.",ssc.Dialog.OfflineSubmitWaitCounter="Left";var focused=!1;!function(e){postcode(),ssc.validator=e("#formc").validate({errorPlacement:function(t,n){e(n).is("select")&&ssc.checkIfMSIE()||e(n).attr({title:t.text()})},highlight:function(t){var n;n=e(t).is("input:radio")?e(t).closest("table"):e(t).is("input:file")?e(t).closest("td"):e(t),n.addClass("error"),n.attr("data-toggle","tooltip"),setTimeout(function(){e("#"+t.id).tooltip({trigger:"hover",placement:"auto right"}).data("bs.tooltip").tip().addClass("stop"),n.attr("data-original-title",n.attr("title"))},100),"function"==typeof ssc.focusOnElement&&ssc.focusOnElement(e(t))},unhighlight:function(t){var n;e(t).is("input:radio")?n=e(t).closest("table"):e(t).is("input:file")?n=e(t).closest("td"):(e(t).hasClass("required")||e(t).hasClass("email"))&&(n=e(t)),void 0===n||n.hasClass("dv")||n.removeClass("error").tooltip("destroy")},ignore:""}),ssc.active_sheet_selector="div.active > div.container-fluid.ssc-responsive-sheet > div.row > section",e("a").on("click",function(t){var n=e(this).attr("href");if("#"==n.slice(0,1)){if(t.preventDefault(),"#"==n)return;var o=e(n);if(0==o.length)return void alert("Oops! This link is broken so can not navigate.");focused=!1,ssc.focusOnElement(o)}}),ssc.focusOnElement=function(t){if(!focused){focused=!0;var n=t.parents(".tab-pane");n.hasClass("active")||e('.nav-tabs a[href="#'+n.attr("id")+'"]').tab("show"),e("html, body").stop().animate({scrollTop:t.offset().top-40},900,"swing",function(){t.focus()})}},e("input[name = 'xlew_1_31_1']").TouchSpin({min:0,max:14,step:2}),e("input[name = 'xlew_1_35_2']").TouchSpin({min:0,max:10,step:1}),e("input[name = 'xlew_1_37_2']").TouchSpin({min:0,max:10,step:1}),e("input[name = 'xlew_1_38_2']").TouchSpin({min:0,max:10,step:1}),e("input[name = 'xlew_1_41_2']").TouchSpin({min:0,max:8,step:1}),e("input[name = 'xlew_1_42_2']").TouchSpin({min:0,max:6,step:1}),e("input[name = 'xlew_1_43_2']").TouchSpin({min:0,max:5,step:1}),e("input[name = 'xlew_1_46_1']").TouchSpin({min:0,max:10,step:1}),e("input[name = 'xlew_1_49_2']").TouchSpin({min:0,max:10,step:1}),e("input[name = 'xlew_1_50_2']").TouchSpin({min:0,max:4,step:1}),e("input[name = 'xlew_1_51_2']").TouchSpin({min:0,max:2,step:1}),e("input[name = 'xlew_1_54_1']").TouchSpin({min:0,max:16,step:1}),e("input[name = 'xlew_1_57_2']").TouchSpin({min:0,max:4,step:1}),e("input[name = 'xlew_1_58_2']").TouchSpin({min:0,max:4,step:1}),e("input[name = 'xlew_1_59_2']").TouchSpin({min:0,max:4,step:1}),e("input[name = 'xlew_1_111_1']").TouchSpin({min:0,max:25,step:1}),e(".btn.btn-sm.button-submit.spin-button").on("click",function(){return submitClick(this),!1}),e(".btn.btn-sm.button-reset").on("click",function(){return resetClick(this),!1}),ssc.isAttachmentExist=function(){var t=!1;return e("input:file").each(function(n,o){var r=e(this).data("files");return r.length>0?(t=!0,!1):void 0}),t},ssc.formSubmitModule.config({url_submit_server:"https://share.spreadsheetconverter.com/submit/",before_onlineformsubmit_callback:function(){e("#onlinefom-submit-conformation-modal").modal("show"),ssc.formSubmitModule.submitThisForm(function(){e("#formc").submit()})},after_onlineformsubmit_callback:function(t,n){e("#onlinefom-submit-conformation-modal").modal("hide");var o=e("#onlineform-submit-status-modal");if("error"===t)o.find(".modal-title").text("Submit Fail."),o.find(".modal-body p").text(n),o.find(".modal-body .status-icon").removeClass("glyphicon-ok-circle").addClass("glyphicon-warning-sign").css("color","rgb(198,0,0)"),o.modal("show");else if(e("#xl_redirect_success").length>0){ssc.Spinner.showModalSpinner();var r=e("#xl_redirect_success").length>0?e("#xl_redirect_success").val():"";r.indexOf("paypal")>-1,r+="",window.top.location.href=r}else o.find(".modal-title").text("Submit Successful."),o.find(".modal-body p").text("The form was successfully submitted."),o.find(".modal-body .status-icon").removeClass("glyphicon-warning-sign warn-icon").addClass("glyphicon-ok-circle").css("color","rgb(53, 197, 21)"),o.modal("show"),ssc.isAttachmentExist()&&e("input[type=file]").parents("td").find(".uploading").find("ul").find("li").each(function(){e(this).data("ssc_fileuploader").destroy()}),void 0!==ssc&&void 0!==ssc.realtimesync&&ssc.realtimesync.sendMessage_FormSubmit()},after_offlineformsubmit_callback:function(t){"success"===t?(e("#offlineforms-submit-conformation-yes-btn").button("reset"),e("#offlineforms-submit-conformation-modal").modal("hide"),e("body").removeClass("modal-open"),e(".modal-backdrop").remove(),ssc.isAttachmentExist()&&e("input[type=file]").parents("td").find(".uploading").find("ul").find("li").each(function(){e(this).data("ssc_fileuploader").destroy()})):"error"===t&&(e("#offlineforms-submit-conformation-modal .info").text("Submit error: Please try later."),e("#offlineforms-submit-conformation-modal .conform").text(""),e("#offlineforms-submit-conformation-yes-btn").hide(),e("#offlineforms-submit-conformation-modal .btn-link").text("close"),e("#offlineforms-submit-conformation-modal .btn-link").show())}});var t=e('input:not(":hidden,:button,[readonly=readonly],:disabled"),select,a.ui-slider-handle,textarea,a.ui-state-active');void 0!=t&&0==t.filter(":first").hasClass("form-control")&&t.filter(":first").focus(),e("textarea[readonly],input[type=text][readonly]").css("background","transparent")}($),ssc.checkIfMSIE=function(){var e=window.navigator.userAgent,t=e.indexOf("MSIE "),n=e.indexOf(".NET CLR");return!(-1===t&&-1===n)},$(document).ready(function(){var e=$(".toggle").closest("td");e.map(function(){var e=getComputedStyle(this).width;if("auto"==e){var t=$(this).parent().show(),n=getComputedStyle(this).width;t.hide(),e=n}$(this.querySelector(".toggle")).css({width:e,height:"30px","min-height":"27px"}),$(this.querySelector(".toggle-on.btn")).css({"padding-right":"0px","padding-left":"0px","margin-right":"14px"}),$(this.querySelector(".toggle-off.btn")).css({"padding-left":"17px",height:"32px",width:e}),$(this.querySelector(".toggle-on, .toggle-off")).css("top","-3px"),$(this.querySelector(".toggle-handle")).css("height","29px")})});